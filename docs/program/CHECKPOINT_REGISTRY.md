...
|---|---|---|---|---|
| CP-00 | `v0.0.0-architecture` | S00 complete | `manual-tests/CP-00_architecture.md` | candidate rebuilding; round-3 acceptance spent, round 5 owed; not ratified, not tagged; see `ratification_blocked` |
