...
|---|---|---|---|---|
| CP-00 | `v0.0.0-architecture` | S00 complete | `manual-tests/CP-00_architecture.md` | accepted candidate; both acceptance streams PASS 2026-09-02; ratification blocked, see manifest `ratification_blocked`; not tagged |
