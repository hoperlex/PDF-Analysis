...
| `routers/{projects,documents,runs,findings,decisions,export}.py` | the nineteen operations |
...
The nineteen-operation assertion compares the router's `(operationId, METHOD, path)` set
