...
| `routers/{projects,documents,runs,findings,decisions,export}.py` | the sixteen operations |
...
The sixteen-operation assertion compares the router's `(operationId, METHOD, path)` set
